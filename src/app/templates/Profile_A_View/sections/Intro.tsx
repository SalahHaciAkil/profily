...
function Intro() {
  return (
    <div>
      <div className="flex flex-col-reverse space-x-7 px-1 items-center justify-center lg:flex-row mt-20 mb-25 border-b-[2px] dark:border-b-[#ffffff0d]">
        ...
        <div className="max-w-[40rem] relative">
          <div className=" shadow-xl shadow-slate-400 absolute z-[-1] h-64 w-96 top-44 right-2 lg:h-[70%] lg:right-[11%] lg:top-[18%] lg:min-w-[27rem] "> hii</div>
          <svg
            className="w-full"
            xmlns="http://www.w3.org/2000/svg"
            width="731.67004"

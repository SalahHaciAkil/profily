  ...
  return (
    <div className="pt-12">
      <div className="flex space-x-7 pe-1 ps-4 lg:flex-row mt-24">
        <div className="flex flex-col space-y-10 flex-1">
          <div className="flex flex-col space-y-7">
            ...
            <h1 className="text-[34px] md:text-[45px] font-bold dark:text-slate-300">
              Hi, I`m <span className="text-primary-300">Gufran Haciakil </span>
              <span className="sm:block">a Frontend Developer</span>
            </h1>
        ...
        <div className="flex-1 max-w-[40rem] relative hidden lg:block">

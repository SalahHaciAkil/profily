...
function Intro() {
  return (
    <div className="p-12">
      <div className="flex flex-col space-x-7 px-1 items-center justify-center lg:flex-row mt-24 mb-25 border-b-[2px] dark:border-b-[#ffffff0d]">
        <div className="flex flex-col space-y-32 max-w-[24rem] md:max-w-[33rem] lg:max-w-[33rem]">
          <div className="flex flex-col space-y-5">
            <p className="tracking-widest	dark:text-slate-300	">
              WELCOME TO MY WORLD
            </p>
            <h1 className="text-[34px] md:text-[45px] font-bold dark:text-slate-300">
              Hi, I`m{" "}
              <span className="text-primary-300">Gufran Haciakil a </span>-
              Frontend Developer
            </h1>
            <p className="leading-7 font-medium text-zinc-500 dark:text-zinc-600">
          ...
          <div>
            <div>
              <h1 className="mb-5 dark:text-slate-300">FIND WITH ME</h1>
              <div className="flex space-x-4 -ml-2">
                <a
                  href="#"
                  className="group rounded-xl transition ease-in-out hover:-translate-y-1 hover:bg-primary-400 duration-300 p-4 shadow-gshadow dark:shadow-darkGshadow dark:hover:bg-inherit dark:hover:shadow-hoverDarkGshadow"
                >
                  {" "}
                  <svg
                    className="w-6 h-6 group-hover:text-slate-200 text-gray-800 dark:text-white "
                    aria-hidden="true"
        ...
        <div className="max-w-[40rem] relative hidden lg:block">
          <div className=" shadow-xl shadow-slate-400 absolute dark:shadow-custom-dark z-50 h-64 w-96 top-44 right-2 lg:h-[70%] lg:right-[11%] lg:top-[18%] lg:min-w-[27rem] ">
            {" "}
          ...
          >
            ...
            />
            <path
              id="uuid-91047c5b-47d7-4179-8a16-40bd6d529b28-171"
            ...
            <path
              id="uuid-c026fd96-7d81-4b34-bb39-0646c0e08e96-172"
